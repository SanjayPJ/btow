		    ...
		    <div id="content" class="col-sm-12">
			    ...
			    <section class="main-content">
			    	...
			    	<div class="resource-row clearfix">
				    	<div class="resource">
					    	<img src="<?php echo get_template_directory_uri() ?>/assets/img/justhost-logo.jpg" alt="Justhost">
				    	...
				    	<div class="resource">
					    	<img src="<?php echo get_template_directory_uri() ?>/assets/img/coda2-logo.jpg" alt="Coda 2">
				    	...
				    	<div class="resource">
					    	<img src="<?php echo get_template_directory_uri() ?>/assets/img/dropbox-logo.jpg" alt="Dropbox">
