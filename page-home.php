	...
	<section id="boost-income">
		<div class="container">
			...
			<div class="section-header">
				<img src="<?php echo get_template_directory_uri() ?>/assets/img/icon-boost.png" alt="Chart">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 col-md-6">
					<div class="row">
						<div class="col-lg-8">
							<h2>Your Instructor <small><?php echo get_post_meta(7, 'author', true); ?></small></h2>
						</div><!-- end col -->
						<div class="col-lg-4">
					...
					<p class="lead">A highly skilled professional, <?php echo get_post_meta(7, 'author', true); ?> is a passionate and experienced web designer, developer, blogger and digital entrepreneur.<p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2">
					...
					<div class="row testimonial">
						<div class="col-sm-4">
							<img src="<?php echo get_template_directory_uri() ?>/assets/img/ben.png" alt="Illustration of a man with a moustache">
						</div><!-- end col -->
						<div class="col-sm-8">
							<blockquote>
